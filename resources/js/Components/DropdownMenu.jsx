        ...
        <Menu as="div" className="relative">
            {({ open }) => (
                <>
                    <Menu.Button
                        className={clsx(
                            'flex items-center gap-x-2 text-gray-600',
                            open && 'text-white'
                        )}
                    >
                        {label}
                    ...
                    >
                        <Menu.Items className="absolute right-0 top-9 w-60 space-y-1 overflow-hidden rounded-lg border border-gray-200 bg-white px-4 py-5 shadow-sm">
                            {children}
                        </Menu.Items>
                    </Transition>
                </>
